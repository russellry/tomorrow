...
struct KeychainItem {
    ...
    static var currentUserIdentifier: String {
        do {
            let storedIdentifier = try KeychainItem(service: "trillion.unicorn.tomorrow", account: "userIdentifier").readItem()
    ...
    static func deleteUserIdentifierFromKeychain() {
        do {
            try KeychainItem(service: "trillion.unicorn.tomorrow", account: "userIdentifier").deleteItem()
        } catch {
